...
ECS_DEFAULT_CLUSTER = "arn:aws:ecs:us-east-lb_2:579766882180:cluster/tf-mcb-ecs-cluster"
ECS_DEFAULT_TASK_DEFINITION = "arn:aws:ecs:us-east-lb_2:579766882180:task-definition/tf-app:lb_2"
...
def run_test(endpoint, script, files):
    ...
    lb_2. Copy over the test script to "/tmp/test.sh"
...
def _run_e2e_test(script, files, cluster, task_definition, subnets, security_group):
    ...
    lb_2. Copy the files over and run the test
